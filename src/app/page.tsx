  ...
  return (
    <main className="main">
      ...
      <div className="message textarea">
        ...
        <MiniStar />
        <p>저희는 강간죄의 구성요건을 피해자의 &apos;동의&apos; 여부로 개정할 의사가 있는지 궁금해하는 시민들의 질문을 <span>167,398번</span> 발송했고</p>
        <Image
          src="/law.svg"
          alt="law"
          width={0}
        ...
        />
        <p>당선된 21대 국회의원 중 <span>206명</span> 이 응답해 비동의 강간죄를 도입하는데 찬성한다는 의견을 보내주셨습니다.</p>
        <MiniStar />
