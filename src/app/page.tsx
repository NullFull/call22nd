  ...
  return (
    <main className="main">
      ...
      <div className="message textarea">
        ...
        />
        <p>당선된 21대 국회의원 중 <span className="blue">206명</span>이 응답해 비동의 강간죄를 도입하는 데 찬성한다는 의견을 보내주셨습니다.</p>
        <MiniStar />
        <p>이후 21대 국회에서는 총 2건의 개정안이 발의되었지만 해당 법안은 무관심 속에 본회의까지 도달하지 못했으며, 현재 21대 국회 법안 처리 기한이 만료되어 기회를 또다시 잃었습니다.</p>
        <MiniStar />
        ...
        />
        <p>우리 동네 지역 국회의원 후보자들에게 강간죄를 개정할 뜻이 있는지 물어봐 주세요.</p>
        <MiniStar />
