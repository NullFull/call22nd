...
const Candidate = ({candidate}) => {
  ...
  return (
    <tr key={candidate.id}>
      ...
      <td className="count">{info.count && `${info.count}회`}</td>
      <td className="agreed">{info.agreed}</td>
      ...
      <table>
        <thead>
          <tr>
            ...
            <td/>
            <td/>
            <td className="count">질문</td>
            <td className="agreed">응답</td>
            <td className="status">이메일</td>
            <td className="sns">SNS</td>
          </tr>
        </thead>
        <tbody>
